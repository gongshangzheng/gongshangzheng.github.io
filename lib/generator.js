...
function buildArticles(paths, allPosts, buildContext, recentCount) {
  ...
  for (const file of pageFiles) {
    ...
    if (isArticle) {
      ...
      const toc = buildTocSidebar(tocResult.headings, allPosts);
