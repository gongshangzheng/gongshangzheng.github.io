    ...
    <div class="main-content">
      <div class="section">
        ...
        <div class="sort-controls">
          ...
          <button class="sort-btn active" data-field="created_at" data-dir="desc">创建时间 ↓</button>
          <button class="sort-btn" data-field="updated_at" data-dir="desc">更新时间 ↓</button>
          <button class="sort-btn" data-field="title" data-dir="asc">标题 A→Z</button>
        </div>
  ...
  for (const cat of catNames) {
    ...
    if (aliasPost) {
      ...
      if (hubHtml) {
        ...
        console.log(`  ↪ category "${cat}" → hub page ${aliasPost.slug}.html`);
      }
      continue;
    }
    let groupedHtml = '';
    ...
    for (const subcat of subcats) {
      ...
      if (subAliasPost) {
        ...
        if (hubHtml) {
          ...
          console.log(`  ↪ subcategory "${cat}/${subcat}" → hub page ${subAliasPost.slug}.html`);
        }
        continue;
      }
