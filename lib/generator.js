...
(function(){
  ...
  function ensurePdfJs() {
    ...
    return loadScript('https://cdn.jsdelivr.net/npm/pdfjs-dist@4.10.38/build/pdf.min.js').then(function(){
      var lib = window.pdfjsLib;
      if (!lib) throw new Error('PDF.js failed to load');
      lib.GlobalWorkerOptions.workerSrc = 'https://cdn.jsdelivr.net/npm/pdfjs-dist@4.10.38/build/pdf.worker.min.js';
      return lib;
    });
  }
