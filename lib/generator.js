...
function buildArticles(paths, allPosts, buildContext, recentCount, options) {
  ...
  for (const file of pageFiles) {
    ...
    // Process shortcodes BEFORE wrapBareParagraphs so that JS code inside
    // {{< jsxgraph >}} / {{< functionplot >}} blocks isn't accidentally wrapped.
    ...
    // LaTeX -> HTML wrappers (run AFTER shortcodes so shortcode output isn't affected).
