...
// Inject post index + xref resolver for [[@Title]] cross-ref resolution
    ...
    if (page.indexOf('class="mermaid"') >= 0 || page.indexOf('class=' + '"mermaid') >= 0) {
      ...
      if (mermaidBodyEndIdx >= 0) {
        page = page.slice(0, mermaidBodyEndIdx) + '<script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script>\n<script>\n(function(){var d=document.documentElement.classList.contains(\'dark\');mermaid.initialize({startOnLoad:true,theme:d?\'dark\':\'base\',themeVariables:d?{primaryColor:\'#1a1a2e\',primaryTextColor:\'#d8cfc2\',primaryBorderColor:\'#3d362c\',lineColor:\'#888\',secondaryColor:\'#2a241d\',tertiaryColor:\'#16213e\',fontFamily:\'system-ui,sans-serif\'}:{primaryColor:\'#f0ece6\',primaryTextColor:\'#2c2418\',primaryBorderColor:\'#d4ccc0\',lineColor:\'#6b5e4f\',secondaryColor:\'#f4f1ec\',tertiaryColor:\'#f0ece6\',fontFamily:\'system-ui,sans-serif\'}},function(svg){var el=typeof svg===\'string\'?document.querySelector(svg):svg;if(!el||!el.querySelector)return;var g=el.querySelectorAll(\'g.label\');for(var i=0;i<g.length;i++){g[i].removeAttribute(\'style\');}var rects=el.querySelectorAll(\'rect.label-container\');for(var j=0;j<rects.length;j++){rects[j].removeAttribute(\'style\');}});\nnew MutationObserver(function(mutations){mutations.forEach(function(m){m.addedNodes.forEach(function(n){if(n.nodeType!==1)return;var svgs=n.querySelectorAll?n.querySelectorAll(\'svg\'):[];if(n.tagName===\'svg\')svgs=[n];svgs.forEach(function(s){var g=s.querySelectorAll(\'g.label\');for(var i=0;i<g.length;i++){g[i].removeAttribute(\'style\');}var rects=s.querySelectorAll(\'rect.label-container\');for(var j=0;j<rects.length;j++){rects[j].removeAttribute(\'style\');}});});});}).observe(document.body,{childList:true,subtree:true});})();\n</script>\n' + page.slice(mermaidBodyEndIdx);
      }
    }
