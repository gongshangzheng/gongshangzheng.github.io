    ...
    <div class="main-content">
      <div class="section">
        ...
        <div class="sort-controls">
          ...
          <button class="sort-btn" data-field="title" data-dir="asc" data-label="标题">标题 A→Z</button>
        </div>
